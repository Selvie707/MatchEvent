package com.example.eventmatchmaker.ui.customview
...
class CustomEditTextEmail : AppCompatEditText, View.OnTouchListener, View.OnFocusChangeListener {
    ...
    private fun init() {
        ...
        passwordDrawable = ContextCompat.getDrawable(context, R.drawable.ic_email) as Drawable
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (!s.toString().contains("@")) {
                    setError(resources.getString(R.string.unValidEmail), null)
                } else {
                    error = null
                }
            }
    ...
    private fun showClearButton() {
        setButtonDrawables(startOfTheText = passwordDrawable, endOfTheText = clearDrawable)
    }
