...
class PreferencesPagingSource(private val token: String) : PagingSource<Int, DataItemCategories>() {
    ...
    override fun getRefreshKey(state: PagingState<Int, DataItemCategories>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DataItemCategories> {
        return try {
